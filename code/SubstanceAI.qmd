...
1.  Do AI students report lower reported parental monitoring compared to non-AI students? We hypothesized that AI students would report lower parental monitoring compared to non-AI students.
...
ggplot(des,aes(x=factor(AI),y=parent_mon_sum)) +
  ...
  labs(x="AI", 
       ...
       title = "Figure 1. Boxplot of Parental Monitoring in AI and Non-AI 15-Year-Old Youths")
...
The independent two-sample t-test on parental monitoring between AI and non-AI 15-year-old participants showed that AI participants reported significantly lower parental monitoring than non-AI participants (M1= `r mean2`, M2= `r mean1`, `r t.value`, df= `r df`, p= `r p.value`).
