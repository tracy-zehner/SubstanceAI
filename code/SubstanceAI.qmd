...
```{r} #need to filter by q4_3 (Are you AI?) where 1=yes}
...
R1 <- na.omit(sub %>%
        select(enddate, startdate, q4_3, b109_1, b109_2, b109_3, b109_4, b109_5, b109_6, b109_7, b109_8, b109_9, q2, q11))
...
R1_clean_num <- cbind(R1_clean, q4_3n,q11_d, b109_1n, b109_2n, b109_3n, b109_4n, b109_5n, b109_6n, b109_7n, b109_8n, b109_9n)
str(R1_clean_num)
...
R1_clean_num <- R1_clean_num%>%
  ...
  mutate(parent_mon_sum_s = (parent_mon_sum-mean(parent_mon_sum)/sd(parent_mon_sum)))
  
##tandardized parental monitoring var by scale()
...
R1_clean_num <- R1_clean_num %>% 
  rename(ever_smoked = q11_d, age = q2, AI = q4_3n)

str(R1_clean_num)


Only15yos <- R1_clean_num %>% filter(age=="(15) 15"& AI=="1")
str(Only15yos)
...
RQ1model <- glm(ever_smoked ~ scale(parent_mon_sum), data=Only15yos, family=binomial(link="logit"))
summary(RQ1model)

#visualizing
#visRQ1 <- Only15yos %>% mutate(prob = ifelse(ever_smoked == "1", 1, 0))
#ggplot(visRQ1, aes(parent_mon_sum, prob)) +
 # geom_point(alpha = 0.15) +
  #geom_smooth(method = "glm", method.args = list(family = "binomial")) +
  #ggtitle("Predicted probabilities for RQ1") +
  #xlab("Parent monitoring") +
  #ylab("Probability of smoking")
##The codes above and below this line essentially generate the same plots
ggplot(Only15yos, aes(parent_mon_sum, ever_smoked)) +
  geom_point(alpha = 0.15) +
  geom_smooth(method = "glm", method.args = list(family = "binomial")) +
  ggtitle("RQ1") +
  xlab("Parent monitoring") +
